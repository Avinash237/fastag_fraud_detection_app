...
# Load the data
df = pd.read_csv(r"C:\Users\DELL\Desktop\Fasttag\fastag_fraud_detection-main\Fastag_Fraud_New_Data.csv")

# Load the encoder
with open(r"C:\Users\DELL\Desktop\Fasttag\fastag_fraud_detection-main\updated_encode_fastag_data.pkl", "rb") as f:
    encoder = pickle.load(f)

# Load the trained models
with open(r"C:\Users\DELL\Desktop\Fasttag\fastag_fraud_detection-main\fastag_xgb_pipe.pkl", "rb") as f:
    model = pickle.load(f)
